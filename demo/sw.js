...
var worker = new PeerWorker({
    version: 1,           // 发布版本号
    logLevel: 'debug',
    allowOrigins: ['https://cdn.rawgit.com'],    // 允许代理的第三方资源origin
    ...
    allowDocumentTypes: ['js', 'css', 'doc', 'docx', 'otf', 'pdf', 'ppt', 'pptx', 'ps', 'xls', 'xlsx'],
    allowOtherTypes: ['swf', 'woff', 'woff2'],
    maxCacheLimit: 150*1024*1024,    // 最大缓存数据量(Byte)
